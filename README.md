...
The **TomTom Maps MCP Server** simplifies geospatial development by providing seamless access to TomTom’s location services, including search, routing, traffic and maps data. It enables easy integration of precise and accurate geolocation data into AI workflows and development environments.
...
All tools use the TomTom Orbis Maps APIs.
...
| `tomtom-poi-categories` | Look up POI category codes to use with the search tools | https://developer.tomtom.com/search-api/documentation/tomtom-orbis-maps/search-service/points-of-interest-search |
...
| `tomtom-routing` | Calculate a route through two or more locations, including multi-stop routes | https://developer.tomtom.com/routing-api/documentation/tomtom-orbis-maps/calculate-route |
...
3. If you still encounter 403 errors, your account may not yet have access to the Orbis preview. Contact TomTom support to request access.
