...
import type { Avoidable, Language, Routes, TravelMode } from "@tomtom-org/maps-sdk/core";
import {
  type BudgetType,
...
function buildBudget(options: ReachableRangeOptions): { type: BudgetType; value: number } {
...
function buildSdkVehicleParams(options: ReachableRangeOptions): Record<string, unknown> | null {
