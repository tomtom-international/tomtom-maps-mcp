...
export type FuzzySearchToolParams = z.input<z.ZodObject<typeof tomtomFuzzySearchSchema>>;
export type PoiSearchToolParams = z.input<z.ZodObject<typeof tomtomPOISearchSchema>>;
export type NearbySearchToolParams = z.input<z.ZodObject<typeof tomtomNearbySearchSchema>>;
export type GeocodeSearchToolParams = z.input<z.ZodObject<typeof tomtomGeocodeSearchSchema>>;
export type ReverseGeocodeSearchToolParams = z.infer<
  z.ZodObject<typeof tomtomReverseGeocodeSearchSchema>
>;
export type PoiCategoriesToolParams = z.input<z.ZodObject<typeof tomtomPOICategoriesSchema>>;
export type AreaSearchToolParams = z.input<z.ZodObject<typeof tomtomAreaSearchSchema>>;
export type EvSearchToolParams = z.input<z.ZodObject<typeof tomtomEvSearchSchema>>;
export type SearchAlongRouteToolParams = z.infer<z.ZodObject<typeof tomtomSearchAlongRouteSchema>>;
