...
import type { AreaSearchParams, SearchAlongRouteResult } from "../services/search/searchService";
import {
  trimSearchResponse,
...
import type {
  GeocodeSearchToolParams,
  ReverseGeocodeSearchToolParams,
  FuzzySearchToolParams,
  PoiSearchToolParams,
  NearbySearchToolParams,
  PoiCategoriesToolParams,
  AreaSearchToolParams,
  EvSearchToolParams,
  SearchAlongRouteToolParams,
} from "../schemas/search/searchSchema";

// Handler factory functions
export function createGeocodeHandler() {
  return async (params: GeocodeSearchToolParams) => {
...
export function createReverseGeocodeHandler() {
  return async (params: ReverseGeocodeSearchToolParams) => {
...
export function createFuzzySearchHandler() {
  return async (params: FuzzySearchToolParams) => {
...
export function createPoiSearchHandler() {
  return async (params: PoiSearchToolParams) => {
...
export function createNearbySearchHandler() {
  return async (params: NearbySearchToolParams) => {
    const { position, show_ui = true, response_detail = "compact", ...options } = params;
    const pos = position as Position;
...
export function createPOICategoriesHandler() {
  return async (params: PoiCategoriesToolParams) => {
...
export function createAreaSearchHandler() {
  return async (params: AreaSearchToolParams) => {
...
export function createEVSearchHandler() {
  return async (params: EvSearchToolParams) => {
...
export function createSearchAlongRouteHandler() {
  return async (params: SearchAlongRouteToolParams) => {
