...
import { getRoute, getReachableRange, calculateEVRoute } from "../services/routing/routingService";
import {
  trimRoutingResponse,
...
export function createReachableRangeHandler() {
  return async (params: ReachableRangeToolParams) => {
...
export function createEVRoutingHandler() {
  return async (params: EvRoutingToolParams) => {
