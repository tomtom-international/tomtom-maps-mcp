...
const { routingHandler, reachableRangeHandler } = await import("./routing");
...
describe("routingHandler", () => {
  ...
  it("should return route result for valid params", async () => {
    ...
    const response = await routingHandler(params);
...
describe("reachableRangeHandler", () => {
  beforeEach(() => vi.clearAllMocks());
  afterEach(() => vi.clearAllMocks());
  ...
  it("should return reachable range result for valid params with time budget", async () => {
    ...
    const response = await reachableRangeHandler(params);
